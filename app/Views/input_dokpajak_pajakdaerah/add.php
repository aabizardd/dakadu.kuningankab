...
<section class="section">
    <div class="section-header">
        ...
        <h1>INPUT DOKUMEN DOKUMEN PAJAK DAERAH</h1>
    ...
    <div class="section-body">
        ...
        <div class="card">
            <div class="card-header">
                <h4> Input Data Dok.Pajak PAJAK DAERAH</h4>
            </div>
            <div class="card-body ">
                <form action="<?= site_url('input_dokpajak_pajakdaerah') ?>" method="POST" autocomplete="off">
                    <?= csrf_field(); ?>
