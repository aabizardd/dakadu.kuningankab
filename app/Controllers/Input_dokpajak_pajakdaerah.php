...
class Input_dokpajak_pajakdaerah extends BaseController
{
    ...
    public function create()
    {
        ...
        return view('input_dokpajak_pajakdaerah/add', $data);
    }
    public function store()
    {
        if (!$this->validate([
            ...
            return redirect()->to('/input_dokpajak_pajakdaerah/add')->withInput();
        }
        ...
        for ($i = 1; $i <= 5; $i++) {
            ...
            if ($file->getError() == 4) {
                ...
                $file->move('img/dokpajak_pajakdaerah', $namaFile);
    ...
    public function saveImg($file)
    {
        ...
        return $this->response->download('img/dokpajak_pajakdaerah/' . $file, null);
    }
